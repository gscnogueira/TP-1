trabalho : main.o dominios.o  controladorasapresentacao.o stubs.o controladorasservico.o persistencia.o
	g++ -std=c++11 -lncurses -l sqlite3 -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -Wall -o trabalho main.o dominios.o controladorasapresentacao.o stubs.o controladorasservico.o persistencia.o
